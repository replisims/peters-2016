...
#' @param sig_threshold threshold of significance defaults to 0.1 as in the original simulation
#'
...
#' @param n Number of participants in intervention and control group (i.e. half the sample size)
...
#' @param c c from confusion matrix (i.e. number of non-events in exposed group)
